# DoubleLinedFrameCharSet Class
 

A <a href="70bef3fa-802e-95ac-4ad8-d97820b4b25f">FrameCharSet</a> for double-lined frames.


## Inheritance Hierarchy
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="70bef3fa-802e-95ac-4ad8-d97820b4b25f">ConControls.Controls.FrameCharSet</a><br />&nbsp;&nbsp;&nbsp;&nbsp;ConControls.Controls.DoubleLinedFrameCharSet<br />
...
**VB**<br />
``` VB
Public Class DoubleLinedFrameCharSet
	Inherits FrameCharSet
```

**C++**<br />
``` C++
public ref class DoubleLinedFrameCharSet : public FrameCharSet
```

**F#**<br />
``` F#
type DoubleLinedFrameCharSet =  
    class
        inherit FrameCharSet
    end
```

The DoubleLinedFrameCharSet type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="6f363f3e-67cb-ebc3-0e10-8c38a882f262">DoubleLinedFrameCharSet</a></td><td>
Initializes a new instance of the DoubleLinedFrameCharSet class</td></tr></table>&nbsp;
<a href="#doublelinedframecharset-class">Back to Top</a>
