# ConsoleControl.DisabledBorderColor Property 
...
**C#**<br />
``` C#
public Nullable<ConsoleColor> DisabledBorderColor { get; set; }
```

**VB**<br />
``` VB
Public Property DisabledBorderColor As Nullable(Of ConsoleColor)
	Get
	Set
```
...
``` C++
public:
property Nullable<ConsoleColor> DisabledBorderColor {
...
**F#**<br />
``` F#
member DisabledBorderColor : Nullable<ConsoleColor> with get, set
